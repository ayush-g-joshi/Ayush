        ...
        body: Builder(builder: (context) {
          return  profileData == null || profileData.isEmpty
            ...
            Center(
              child: ClipOval(
                child: Container(
                height: 200, width: 200, color: Color(0xff113162),
                  child: FittedBox(
                    child: Image.network(
                    '$image'),
                    fit: BoxFit.fill,
                ...
                Text("Name-$firstName $lastName",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),),
                SizedBox(
                  height: 10,
                ),
                Text("DOB-$dateOfBirth",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),),
                SizedBox(
                  height: 10,
                ),

                Text("Mobile No-$mobile ",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),),
                SizedBox(
                  height: 10,
                ),
                Text("Email-$email",style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 20),),
                SizedBox(
                  height: 10,
                ),
                Padding(
